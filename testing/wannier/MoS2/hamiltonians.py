...
# dimensionality of the system
  ...
  def get_bands(self,nkpoints=100,use_lines=False,kpath=None):
    """ Returns a figure with teh bandstructure"""
    if self.dimensionality<2: # for 0d and 1d system
      get_bands(self,nkpoints=nkpoints)
    if self.dimensionality==2:  # for 2d system
      get_bands_2d(self,kpath=kpath)
