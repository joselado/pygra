...
# dimensionality of the system
  ...
  def add_rashba(self,c):
    ...
    if g.dimensionality==1:  # one dimensional
      self.inter += rashba(g.r,r2=g.r+g.a1,c=c)
    if g.dimensionality==2:  # two dimensional
      self.tx += rashba(g.r,r2=g.r+g.a1,c=c)
      self.ty += rashba(g.r,r2=g.r+g.a2,c=c)
      self.txy += rashba(g.r,r2=g.r+g.a1+g.a2,c=c)
      self.txmy += rashba(g.r,r2=g.r+g.a1-g.a2,c=c)
