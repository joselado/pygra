...
mf = None
scf = meanfield.Vinteraction(h,V1=3.0,U=0.0,mf=mf,V2=3.0,V3=0.0,nk=3,filling=0.5,mix=0.2,compute_dd=False)
mix0 = h.extract("hopping_spin_mixing")
...
exit()
mix1 = h.extract("hopping_spin_mixing")
...
#print(h.extract("mx"))
#print(h.extract("my"))
print("Mx",h.extract("mx"))
print("My",h.extract("my"))
